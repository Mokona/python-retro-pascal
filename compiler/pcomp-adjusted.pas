(*$T-,L+,C+*)
  ...
  *                                                       *
  *     CONVERTED BACK TO P2 COMPATIBLE FOR SELF          *
  *     COMPILATION, KEEPING THE BUG-FIXES AND ADJUSTING  *
  *     FOR SOME OTHER BUG FIXES. ANNOTATED WITH MY       *
  *     INITIALS [SG] ON MAY 22, 2023                     *
  *********************************************************)
...
VAR
 (*PRD, PRR:                    TEXT; *)
    ...
    (* ALL CHARACTERS SEEM LIMITED TO 64 POSITIONS, SO BACK TO A RANGE [SG] *)
    SSY: ARRAY [' '..'^' (*'+'..';'*)] OF SYMBOL;
...
1:  FCP := LCP
  ...
  PROCEDURE INITTABLES;
    ...
    BEGIN
      ...
      (* AGAIN BASED ON CDC CHARSET. LEADS TO ')' BEING UNDEFINED. [SG] *)
